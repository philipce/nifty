 ...
 *  gt.swift
 *
 *  This file provides functionality for greater-than comparison.
 *
...
func gt(_ A: Matrix, _ B: Matrix) -> Matrix
{
...
/// - Returns: matrix with ones where comparison is true and zeros elsewhere
func gt(_ A: Matrix, _ b: Double) -> Matrix
{
    var m = [Double]()
    for i in 0..<numel(A)
    {        
...
///     - b: Number to compare against
/// - Returns: matrix with ones where comparison is true and zeros elsewhere
func gt(_ A: Matrix, _ b: Int) -> Matrix
{
...
/// - Returns: matrix with ones where comparison is true and zeros elsewhere
func gt(_ a: Double, _ B: Matrix) -> Matrix
{
    var m = [Double]()
    for i in 0..<numel(B)
    {        
...
///     - B: Matrix to compare against
/// - Returns: matrix with ones where comparison is true and zeros elsewhere
func gt(_ a: Int, _ B: Matrix) -> Matrix
{
