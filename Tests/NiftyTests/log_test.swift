 ...
 *  log_test.swift
 *
 *  This file tests the log function.
 *
...
class log_test: XCTestCase 
{
    ...
    {        
        ...
        XCTAssert(isequal(log(v1), v1_answer, within: 0.0001))
        ...
        XCTAssert(isequal(log(m1), m1_answer, within: 0.0001))
